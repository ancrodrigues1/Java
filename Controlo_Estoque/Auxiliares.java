...
public class Auxiliares {
    ...
    public static String opCanceladaSaldoNegativo = "\n\n *Operação cancelada, saldo produto não pode ser negativo!*";
    ...
    public static int entradaIntPositivo(String mensagem){
        Scanner scn = new Scanner(System.in);
        int valorTemp = 0;
        while(true){
    ...
    public static double entradaDoublePositivo(String mensagem){
        Scanner scn = new Scanner(System.in);
    ...
    public static double entradaDoubleNuloPositivo(String mensagem){
        Scanner scn = new Scanner(System.in);
        double valorTemp = 0.0;
        while(true){
            System.out.print(mensagem);
            if(scn.hasNextDouble()){
                ...
                if (valorTemp>=0){
                    ...
                    System.out.println("\n *Erro: Valor deve ser igual ou maior que zero.");
                }
            } else {
                System.out.println("\n *Erro: Entrada inválida!!.");
                scn.nextLine();
    ...
    public static long entradaLongPositivo(String mensagem){
        Scanner scn = new Scanner(System.in);
        long valorTemp = 0;
        while(true){
            System.out.print(mensagem);
            if(scn.hasNextDouble()){
                valorTemp = scn.nextLong();
                if (valorTemp>0){
                    break;
                } else {
    ...
    public static int entradaIVA(String mensagem){
        Scanner scn = new Scanner(System.in);
        int resultado = 0;
        while(true){
           resultado = entradaInt(mensagem);
           if (resultado==0 || resultado==6 || resultado==13 || resultado==23){
               break;
           } else {
               System.out.println("\n *Iva Inválido, informar IVA Válido.");
           }
        }
        return resultado;
    }
